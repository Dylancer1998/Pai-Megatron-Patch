...
# Model parallel source rank for DP > 1 generation 
_MODEL_PARALLEL_SRC_RANK = None
# Embedding group.
...
def initialize_model_parallel(
    ...
    global _MODEL_PARALLEL_SRC_RANK
    ...
    for i in range(data_parallel_size * context_parallel_size):
        ...
        if rank in ranks:
            ...
            _MODEL_PARALLEL_SRC_RANK = ranks[0]
...
def get_model_parallel_src_rank():
    """ Return the source rank in a model parallel group
    don't support: with_context_parallel=False
    """
    return _MODEL_PARALLEL_SRC_RANK
